...
\begin{document}
  ...
  \author[5]{Martijn de Vos}
  \runningauthor{Pouwelse, de Kok, Fleuren, Hoogendoorn and de Vos}
  ...
  \affil[4]{ABN AMRO}
  \affil[5]{Department of Software Technology, Delft University of Technology}
