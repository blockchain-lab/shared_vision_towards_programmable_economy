...
While there has been promising advances in the field of cybercurrency, we do not consider this research in the remainder of this work.
...
These centralized bureaucracies which govern these records have not changed much, while technological innovations like autonomous vehicles and virtual reality are changing the world at a fast pace. %the world is slowly being filled with autonomous vehicles, . 
...
Physical devices for security purposes are already widely used, mainly as mean to implement a two-factor authentication system.
...
We conducted a small experiment with our prototype to estimate in how accurately fingerprints are matched.
...
We created our decentralized marketplace and integrated it in Tribler.
